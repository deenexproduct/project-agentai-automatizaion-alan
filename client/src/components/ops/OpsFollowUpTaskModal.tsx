...
import { createOpsTask } from '../../services/ops.service';
import { TaskData } from '../../services/crm.service';
...
export default function OpsFollowUpTaskModal({ completedTask, open, onClose, onCreated }: Props) {
    ...
    const handleCreate = async () => {
        setCreating(true);
        try {
            const datePart = selectedOption.value.split('T')[0];
    ...
    return (
        ...
        >
            ...
            >
                <div className="h-1 bg-gradient-to-r from-sky-500 via-blue-500 to-emerald-400" />
                ...
                <div className="p-6 pb-2">
                    <div className="flex items-start gap-4 mb-5">
                        <div className="w-12 h-12 rounded-[16px] bg-gradient-to-br from-sky-100 to-blue-100 border border-sky-200/60 flex items-center justify-center shrink-0 shadow-inner">
                            <CalendarPlus size={24} className="text-sky-600" />
                        </div>
                    ...
                    <div className="flex gap-3 mb-5">
                        <div className="relative flex-1">
                            <button
                                ...
                                className="w-full flex items-center justify-between gap-2 px-4 py-3 bg-white border border-slate-200 rounded-[14px] text-[14px] font-medium text-slate-700 hover:border-sky-300 hover:bg-sky-50/30 transition-all shadow-sm cursor-pointer"
                            >
                        ...
                        <div className="relative w-[130px] shrink-0">
                            ...
                            <input
                                ...
                                className="w-full pl-9 pr-2 py-3 bg-white border border-slate-200 rounded-[14px] text-[14px] font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-sky-200 focus:border-sky-300 transition-all shadow-sm"
                            />
                        </div>
                    </div>
                </div>
                ...
                <div className="px-6 pb-6 flex gap-3">
                    <button
                        ...
                        disabled={creating}
                        className="flex-1 py-3 px-5 bg-gradient-to-r from-sky-600 to-blue-600 text-white font-bold rounded-[14px] text-[14px] hover:shadow-[0_8px_24px_rgba(14,165,233,0.4)] hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:shadow-none shadow-[0_4px_16px_rgba(14,165,233,0.3)] flex items-center justify-center gap-2"
                    >
                        {creating ? (
