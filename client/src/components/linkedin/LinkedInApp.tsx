...
export default function LinkedInApp() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #f8f7ff 0%, #f0ecff 50%, #ede9fe 100%)",
      }}
    >
      ...
      >
        <div
          className="flex-1 flex flex-col items-center gap-2 overflow-y-auto w-full custom-scrollbar-sidebar pb-4"
        ...
        >
          <div className="flex items-center gap-3">
            <h1
              ...
              style={{
                background:
                  "linear-gradient(90deg, rgb(124, 58, 237), rgb(168, 85, 247)) text",
