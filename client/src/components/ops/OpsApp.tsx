...
export default function OpsApp() {
  ...
  const hasBothPlatforms =
    ...
    user?.platforms?.includes("operaciones");
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="flex-1 flex flex-col items-center gap-2 overflow-y-auto w-full pb-4"
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div
          ...
          style={{ paddingLeft: 12, paddingRight: 12, paddingTop: 0 }}
        >
          {activeTab === "dashboard" && <OpsDashboard />}
          {activeTab === "pipeline" && (
            <PipelineBoard urlDealId={id} platform="operaciones" />
          )}
          ...
          {activeTab === "companies" && (
            <CompanyList urlCompanyId={id} platform="operaciones" />
          )}
          {activeTab === "contacts" && (
            <ContactList urlContactId={id} platform="operaciones" />
          )}
